...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            name='BinaryModel',
            fields=[
                ('model_param_link', models.ForeignKey(db_column='model_param_link', on_delete=django.db.models.deletion.CASCADE, primary_key=True, serialize=False, to='sourcepage.papers', to_field='model_param_link')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('model_param_link', models.ForeignKey(db_column='model_param_link', on_delete=django.db.models.deletion.CASCADE, to='sourcepage.papers', to_field='model_param_link')),
            ],
        ),
    ]
